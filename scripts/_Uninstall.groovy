...
//
// check to see if we already have a LogbackGriffonAddon
// def configText = '''root.'LogbackGriffonAddon'.addon=true'''
// if(builderConfigFile.text.contains(configText)) {
//     println 'Removing LogbackGriffonAddon from Builder.groovy'
