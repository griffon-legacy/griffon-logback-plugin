...
import org.codehaus.griffon.runtime.logging.logback.GriffonApplicationEventLogbackAppender
import org.codehaus.griffon.runtime.logging.logback.HtmlEncoder
import org.codehaus.griffon.runtime.logging.logback.LogLog
import org.codehaus.griffon.runtime.logging.logback.LogbackConsoleAppender
import org.codehaus.griffon.runtime.logging.logback.LogbackLoggerAdapter
import org.codehaus.griffon.runtime.logging.logback.LogbackLoggerFactory
import org.codehaus.griffon.runtime.logging.logback.XmlEncoder
...
class LogbackConfig {
    ...
    protected static final APPENDERS = ['null': NOPAppender, console: ConsoleAppender,
        file: FileAppender, rollingFile: RollingFileAppender, event: GriffonApplicationEventLogbackAppender]
    ...
    protected Appender createConsoleAppender() {
        Appender consoleAppender = new LogbackConsoleAppender(config)
    ...
    protected Appender createFullstackTraceAppender() {
        ...
        File targetDir = Metadata.current.getGriffonWorkingDir()
